...
<div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Buat event seminar, workshop, konferensi, atau training baru</p>
    </div>

    <!-- Form -->
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <form action="/admin/events/store" method="post" enctype="multipart/form-data" class="space-y-6 p-6">
            <?= csrf_field() ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="4" 
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" 
                                  placeholder="Deskripsi detail tentang event" required><?= old('description') ?></textarea>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Draft: Event tidak akan terlihat oleh user. Published: Event dapat dilihat dan didaftar oleh user.</p>
            ...
            <div class="pb-6">
                ...
                <div>
                    ...
                    <textarea id="certificate_template" name="certificate_template" rows="4" 
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" 
                              placeholder="Template untuk sertifikat (opsional)"><?= old('certificate_template') ?></textarea>
